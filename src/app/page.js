    ...
    <div className="text-center">
      ...
      <section className="py-20 bg-gray-50 -mx-6 px-6">
        ...
        <div className="max-w-5xl mx-auto grid md:grid-cols-3 gap-8 text-left">
          <div className="bg-white p-8 rounded-xl shadow-daangn border border-border">
            <h3 className="text-xl font-bold mb-2 text-primary">관심사 기반 추천</h3>
            <p className="text-secondary">내 종목에 관심있는 후원사, 우리 브랜드에 딱 맞는 선수를 추천받아요.</p>
          </div>
          <div className="bg-white p-8 rounded-xl shadow-daangn border border-border">
            <h3 className="text-xl font-bold mb-2 text-primary">안전한 채팅 제안</h3>
            <p className="text-secondary">플랫폼이 검토한 믿을 수 있는 제안만, 안심하고 채팅으로 대화해요.</p>
          </div>
          <div className="bg-white p-8 rounded-xl shadow-daangn border border-border">
            <h3 className="text-xl font-bold mb-2 text-primary">투명한 계약 관리</h3>
            <p className="text-secondary">복잡한 계약 과정은 플랫폼에서 도와드려요. 투명하게 진행하고 관리하세요.</p>
          </div>
        </div>
      </section>
    </div>
